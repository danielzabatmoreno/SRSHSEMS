                        ...
                        <div class="card-header">
                            ...
                            <h6 class="card-subtitle text-muted">
                                <nav class="navbar bg-body-light">
                                    <div class="container-fluid">
                                        <form class="d-flex justify-content-between align-items-center w-100" role="search" method="GET" action="{{ route('students.index') }}">
                    <div class="d-flex">
                                        ...
                                        @foreach($students as $student)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('students.destroy', $student->StudentID) }}" 
                                                    method="POST" 
