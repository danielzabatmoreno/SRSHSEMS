                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('students.update', $students->StudentID) }}" enctype="multipart/form-data" class="row g-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control" value="{{ old('email', $students->Email) }}" required>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="GradeLevel" class="form-control" required>
                                            <option value="Grade 11" {{ $students->GradeLevel == 'Grade 11' ? 'selected' : '' }}>Grade 11</option>
                                             <option value="Grade 12" {{ $students->GradeLevel == 'Grade 12' ? 'selected' : '' }}>Grade 12</option>
                                    </select>
                                </div>
