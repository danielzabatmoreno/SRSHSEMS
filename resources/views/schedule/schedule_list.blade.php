                    ...
                    <div class="card border-0">
                        <div class="card-header">
                            <nav class="navbar bg-body-light">
                                <div class="container-fluid">
                                    <form class="d-flex justify-content-between align-items-center w-100" role="search" method="GET" action="{{ route('schedule.index') }}">
                    <div class="d-flex">
                        <input class="form-control me-2" type="search" name="search" 
                             placeholder="Search by Schedule Name" aria-label="Search" 
                             value="{{ request('search') }}">
                        <button class="btn btn-outline-success" type="submit">
                             <i class="fa-solid fa-magnifying-glass"></i>
                        </button>
                     </div>
                        <a href="{{ route('schedule.create') }}" class="btn btn-info">
